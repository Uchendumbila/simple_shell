...
/**
 * cd_dot - Writing a fxn that changes to the parent directory
 *
...
/**
 * cd_to - Writing a fxn that changes to a directory given
 * by the user
 *
...
/**
 * cd_previous - Writing a fxn that changes to the previous directory
 *
 * @datash: data relevant (environ)
 *
 * Return: no return
...
/**
 * cd_to_home - Writing a fxn that changes to home directory
 *
 * @datash: data relevant (environ)
 *
 * Return: no return
